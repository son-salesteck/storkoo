...
// $ = jQuery.noConflict();
    ...
    BootstrapNotify.notify = function (title, message, icon, type ) {
        ...
        $.notify(content, {
            ...
            template:
            '<div data-notify="container" class="col-xs-11 col-sm-4 alert alert-{0}" role="alert">' +
                '<button type="button" style="top: 0;" aria-hidden="true" class="close" data-notify="dismiss"><i class="icon-x"></i></button>' +
                '<span data-notify="icon"></span>' +
                '<span data-notify="title">{1}</span>' +
                '<span data-notify="message">{2}</span>' +
                // '<div class="progress" data-notify="progressbar">' +
                //     '<div class="p-progress-bar progress-bar-{0}" role="progressbar" aria-valuenow="0" ' +
